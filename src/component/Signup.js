...
const changemodal=(event)=>{
  ...
  return (
    ...
    <div className='signcss'>
      ...
      <h2 style={{color:"white"}}  className='text-center' >Create an account to use Hypes<span style={{color:"#69c782", fontWeight:"bold"}}>Bloggy</span></h2>
      <div>
  ...
  <button className="button-primary" style={{width:"23vw"}} >Submit</button>
  </div>
</form>
    </div>
    </div>
