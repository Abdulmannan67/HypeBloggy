...
import Noteitem from './Blogsitem'
...
const Notes = (props) => {
    ...
    const { getuser_blogs,userblog ,editNote} = context;
...
<div className="modal fade" id="exampleModal" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div className="modal-dialog" role="document">
    ...
    <div className='row pt-3 mx-2' >
        <h1 style={{color:"black"}} className='text-center'>Your <span style={{color:"#69c782", fontWeight:"bold"}}>Blogs</span></h1>
  ...
  <i className="fas fa-search" aria-hidden="true"></i>
        ...
        {userblog.length===0 && "No blogs to display"}
        {userblog.map((no)=>{
